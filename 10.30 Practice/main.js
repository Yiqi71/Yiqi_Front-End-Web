...
function countInContainer1() {
    ...
    document.getElementById('output2').innerText = `There are ${elementsInContainer1} elements inside container1.`;
}
...
function countInContainer2() {
    ...
    document.getElementById('output3').innerText = `There are ${elementsInContainer2} elements inside container2.`;
}
